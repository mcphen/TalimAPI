            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title">{{ editMode ? 'Modification ': 'Nouveau '}} Filiere</h4>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input v-model="form.filiere" type="text" name="role" required
...
export default {
    ...
    methods: {
        ...
        update_role(id){
            ...
            this.form.put('/api/filieres/'+id).then((data)=>{
        ...
        edit_role(role){
            //console.log(role.filiere);
            this.editMode = true;
            this.form.reset();
            $('#modalAddRole').modal('show');
            this.form.filiere=role.filiere;
        ...
        delete_role(id){
            ...
            Swal.fire({
                ...
                if(result.value==true){
                    axios.delete('/api/filieres/'+id).then(resp =>{
