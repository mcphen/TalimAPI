                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input v-model="form.libelle_pays" type="text" name="role" required
...
export default {
    ...
    methods: {
        ...
        update_role(id){
            ...
            this.form.put('/api/pays/'+id).then((data)=>{
        ...
        edit_role(role){
            ...
            this.form.reset();
            $('#modalAddRole').modal('show');
            this.form.libelle_pays=role.libelle_pays;
        ...
        delete_role(id){
            ...
            Swal.fire({
                ...
                if(result.value==true){
                    axios.delete('/api/pays/'+id).then(resp =>{
