            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title">{{ editMode ? 'Modification ': 'Nouveau '}} niveau</h4>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input v-model="form.niveau" type="text" name="role" required
...
export default {
    ...
    methods: {
        ...
        update_role(id){
            ...
            this.form.put('/api/niveaux/'+id).then((data)=>{
        ...
        edit_role(role){
            //console.log(role.niveau);
            this.editMode = true;
            this.form.reset();
            $('#modalAddRole').modal('show');
            this.form.niveau=role.niveau;
        ...
        all_role(){
            axios.get('/api/niveaux').then(data =>{
        ...
        delete_role(id){
            ...
            Swal.fire({
                ...
                if(result.value==true){
                    axios.delete('/api/niveaux/'+id).then(resp =>{
